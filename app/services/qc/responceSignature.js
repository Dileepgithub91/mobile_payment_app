...
//   var requestHttpMethod = "post";
   ...
   */
//   var absApiUrl =
    // "https://<This will be shared as part of provisioning the partner>/rest/v3/orders";
...
//   var clientSecret = "secret string";
  ...
  let getConcatenateBaseString = () => {
    ...
    if (responseBody) {
      baseArray.push(
        fixedEncodeURIComponent(JSON.stringify(sortObject(responseBody)))
      );
    }
